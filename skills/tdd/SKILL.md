...
Require repository adoption and follow [workflow](../workflow/SKILL.md) plus the repository-root `AGENTS.md`. Read relevant domain language and ADRs when they affect the behavior under test.
